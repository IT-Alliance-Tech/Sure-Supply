      ...
      <Box sx={{
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Typography variant="h3" fontWeight="bold" gutterBottom  sx={{  fontSize: { xs: '2rem', md: '3rem', lg:'48px' }, fontStyle :'italic', 
        ...
        <Box sx={{ position: 'relative', bgcolor: 'white', borderRadius: 2, overflow: 'hidden' }}>
          ...
          {selectedImage && (
            <Box>
              ...
              <Box sx={{ p: 3 }}>
                <Typography variant="h5" gutterBottom sx={{ fontWeight: 600, color:"#D50A17" }}>
