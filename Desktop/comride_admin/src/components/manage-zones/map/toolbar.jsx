    ...
    <>
        ...
        {isEditable ? (
          <>
            ...
            {!currPoly?.id && action === "create" && (
              <button
                type="button"
                className="primary_bg border-0 primary_bg rounded-1 newmap_mini__btn"
                onClick={() => {
              ...
              >
                <i
                  className={`ri-pencil-fill ${
                    drawing ? "spanish_gray_color" : "text-white"
                  }`}
                ></i>
              </button>
            )}
          ...
          <>
            ...
            >
              <i className="ri-fullscreen-fill text-white"></i>
            </button>
          </>
        )}
      </div>
      ...
      >
        <div className="d-flex justify-content-between align-items-center">
          ...
          >
            <i className={`${!open ? "ri-add-line" : "ri-close-line"} `}></i>
          </button>
        </div>
        {open && (
