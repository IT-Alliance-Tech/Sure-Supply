...
const BookingBillingDetails = ({
  ...
  console.log(BookingData, "alksdalkddas");
  ...
  console.log(BookingData?.billingDetails?.driver_fine, "jhsdgajdgakjd");
  ...
  console.log(BookingData?.billingDetails?.rider_payment_details, "jchjdkajds");
  ...
  console.log(
    BookingData?.billingDetails?.rider_payment_details?.amount_to_be_refunded,
    "alksdalkddas"
  );
          ...
          <div className="row g-0">
            ...
            <div className="col-xxl-5 col-md-6 col-sm-12 py-2">
              <div className="d-flex gap-3 align-items-top me-5">
                ...
                <div className="input_border border_radius px-2 w_90">
                  <div
