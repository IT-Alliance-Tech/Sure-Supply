...
const TripInformation = ({
  ...
  console.log(bookingData?.tripInformation?.StartOtp);
  ...
  console.log(bookingData, "sjfgasjksa");
  ...
  useEffect(() => {
    ...
    dispatch(manageDriverVehicleTypeListAction(onSuccess, onError));
  }, []);
  ...
  const vehicleDetails = [
    {
      label: " Vehicle ID",
      value: bookingData?.tripInformation?.driver?.vehicle_type
        ?.vehicle_type_id2
        ? bookingData?.tripInformation?.driver?.vehicle_type?.vehicle_type_id2
        : "--",
      navigation: true,
    },
    {
          ...
          <div className="col-lg-4 col-md-4 col-sm-8 mt-sm-4 py-2">
            <div className="d-flex align-items-center gap-2 me-5 ">
              ...
              <div className="input_border border_radius px-xxl-2 w_90">
                ...
                >
                  <div>
                    <i className="ri-download-2-line fs_14 secondary_color pe-2"></i>
                  </div>
                  <div className="secondary_color fs_14 fw_600 d-flex align-items-center text-nowrap download_invoice">
                    Download Invoice
                  </div>
                  <div>
                    <i className="ri-arrow-down-s-fill fw_900 fs_18 primary_color"></i>
                  </div>
                </div>
              </div>
              ...
              <div className="position-relative">
                <span className="pe-2">
                  ...
                  <i
                    className="ri-more-2-fill fs_14 py-2 px-2  fw_700 border_radius_5px orange_yellow_bg cursor_pointer"
                    onClick={() => {
