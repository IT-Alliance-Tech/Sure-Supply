...
const RiderBilling = ({
  ...
  const riderBillingData =
    Data?.billingDetails?.rider_billing ?? Data?.rider_billing;
  const estimatedRiderBillingData =
    Data?.billingDetails?.estimate_rider_billing ??
    Data?.estimate_rider_billing;
  ...
  console.log(disableCancelBtn?.afterOtp, "jasgdasd");
