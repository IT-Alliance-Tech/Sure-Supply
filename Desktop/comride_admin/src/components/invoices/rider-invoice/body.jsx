...
const Body = ({ item }) => {
  ...
  const localBillingDetailsAfterOtp = [
    ...
    },
    {
      ...
      values: item?.booking?.rider_billing?.remaining_trip_fare !== null
      ? parseFloat(item?.booking?.rider_billing?.remaining_trip_fare).toFixed(2)
      : "--",
    },
    {
      label: "Waiting Fee",
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <View style={{ flexDirection: "row" }}>
                ...
                >
                  {status === "Completed" ? (
                    <Image
                      source={require("../../../assets/images/green-check-image.png")}
                      style={{
                        height: "10px",
                        borderRadius: "5px",
                        marginTop: "2px",
