...
const VehicleTypeModal = ({
  ...
  const formik = useFormik({
    ...
    initialValues: {
      ...
      vehicleModel: vehicleTypeView?.vehicle_model ?? "",
      rideType: vehicleTypeView?.ride_type?.id ?? "",
      vehicleColor: vehicleTypeView?.vehicle_color ?? "",
      ...
      >
        <Modal.Body className=" pt-2">
          <div className="d-flex justify-content-between ">
            ...
            <div
              onClick={() => handleVehicleTypeClose()}
              className="cursor_pointer"
            >
              <i className="ri-close-circle-fill primary_color fs_24"></i>
            </div>
          </div>
          {type !== "createVehicleType" && (
