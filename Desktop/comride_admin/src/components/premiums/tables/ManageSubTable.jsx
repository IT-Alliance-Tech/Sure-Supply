...
const ManageViewTable = ({ location, params }) => {
  ...
  useEffect(() => {
    setLoading(true);
    dispatch(
      managePremium.managePremiumRideListAction(
        {
          pageno: page,
          id: params.id,
        },
...
// console.log(item?.zoneName?.zone_name,"cgchhhhhhhhhhhhhhhhhhhhh");

  return (
    <>
      <InnerLayout
        mainHeading={`Manage Premiums - ${location?.state?.zonename} Zone`}
        navigateEnable={true}
        buttons={buttonList}
        heading_classname={""}
      >
                    ...
                    <tr>
                      ...
                      <td className="">
                        <NavLink
                          ...
                          to={`/driver-premium/premium/view/${item?.zoneName?.id}/${item?.ride_type?.id}`}
                          state={{
                            edit: false,
                      ...
                      <td className="">
                        <NavLink
                          ...
                          to={`/driver-premium/premium/edit/${item?.zoneName?.id}/${item?.ride_type?.id}`}
                          state={{
                            edit: true,
                            zones: item?.zoneName?.zone_name,
                            ridetype: item?.ride_type?.ride_type,
