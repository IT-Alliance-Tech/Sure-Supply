...
const VehicleType = () => {
  ...
  const onDropDownListSuccess = (data) => {
    ...
    setVehicleTypeDropdwn({
      ...
      ride_type: [...new Set(data?.data?.map((item) => item?.ride_type?.ride_type))].map(
      ...
      updated_by: [...new Set(data?.data?.map((item) => item?.UpdatedBy?.user_name))].map(
                  ...
                  {items.map((item) => (
                    <tr key={item.ID} className={"light_blue_bg"}>
                      ...
                      <td>
                        ...
                        <span className="secondary_color fs_14">
                          {item?.vehicle_model
                            ? removeUnderScore(item?.vehicle_model)
                            : "--"}
                        </span>
                      </td>
                      ...
                      <td>
                        ...
                        <span className="secondary_color fs_14">
                          {item?.vehicle_color
                            ? removeUnderScore(item?.vehicle_color)
                            : "--"}
                        </span>
                      </td>
                      <td>
